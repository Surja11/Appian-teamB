...
<section class="faq-section container pt-20 ps-5 pe-5 pb-39 pt-lg-20 pb-lg-20 ps-lg-14 pe-lg-14">
  <header>
          ...
          <?php while (have_rows('faq_loop')) : the_row(); ?>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button <?php echo ($count === 1) ? '' : 'collapsed'; ?> subheading-3 pt-6 pb-6" 
                        type="button" 
                  ...
                  <img src="<?php echo esc_url(get_template_directory_uri()); ?>/resources/images/open-close.png" alt="close button" class="accordion-chevron" />
                </button>
              </h2>
              <div id="<?php echo esc_attr($collapse_id); ?>" class="accordion-collapse collapse <?php echo ($count === 1) ? 'show' : ''; ?> pb-6" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body body body-small">
