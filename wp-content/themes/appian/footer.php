                ...
                <div class="footer-middle-layout-engine">
                    ...
                    <div class="linkedin-wrapper">
                        <a href="<?php echo !empty($footer['linkedin_url']) ? esc_url($footer['linkedin_url']) : '#'; ?>"
                            ...
                            <svg class="linkedin-icon-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            if (subscribeForm && subscribeWrapper && emailInput) {
                subscribeForm.addEventListener('submit', function (e) {
                    ...
                    if (emailValue.length > 100) {
                        alert("Error: The email address entered is too long. Please enter an email shorter than 100 characters.");
                        emailInput.focus();
                        return;
                    }
