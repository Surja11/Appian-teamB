...
?>
        ...
        <div class="our-projects__pagination d-flex align-items-center justify-content-center mt-20 mb-25 mt-md-15">

            <button class="our-projects__pagination-arrow our-projects__pagination-arrow--prev d-flex align-items-center justify-content-center bg-transparent border-0 p-0 <?php echo $page <= 1 ? 'opacity-0' : ''; ?>"
            ...
            <button class="our-projects__pagination-arrow our-projects__pagination-arrow--next d-flex align-items-center justify-content-center bg-transparent border-0 p-0 <?php echo $page >= $total_pages ? 'opacity-0' : ''; ?>"
                data-page="<?php echo $page + 1; ?>"
