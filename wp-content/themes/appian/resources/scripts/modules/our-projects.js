document.addEventListener("DOMContentLoaded", function () {
  ...
  const enablePagination =
    section.getAttribute("data-enable-pagination") === "true";
  ...
  const mobileDropdownMenu = document.querySelector(
    ".our-projects__filter-dropdown-menu",
  );
  const mobileFilterOptions = document.querySelectorAll(
    ".our-projects__filter-option",
  );
  const mobileFilterSelected = document.querySelector(
    ".our-projects__filter-selected",
  );
  const mobileFilterArrow = document.querySelector(
    ".our-projects__filter-arrow",
  );
  ...
  function initPaginationClicks() {
    const pageNumbers = cardsContainer.querySelectorAll(
      ".our-projects__pagination-number",
    );
    ...
    const prevBtn = cardsContainer.querySelector(
      ".our-projects__pagination-arrow--prev",
    );
    const nextBtn = cardsContainer.querySelector(
      ".our-projects__pagination-arrow--next",
    );

    if (prevBtn) {
      prevBtn.addEventListener("click", () => {
        if (!prevBtn.disabled)
          loadProjects(currentFilter, currentPage - 1, true);
      });
    }
